...
// estudiantes
import Alumnos from '../views/App/Alumnos/Alumnos'

// autos
import Autos from '../views/App/Autos/Autos'

// apps
import Apps from '../views/App/Apps/Apps'

import Librerias from '../views/App/Librerias/Librerias.vue'
...
const PracticasRoutes = (prop, mode) => [
  {
    path: 'practicas',
    name: prop + '.practicas',
    meta: { dark: mode, auth: true, name: 'practicas' },
    component: Practicas
  }
]

const LibreriasRoutes = (prop, mode) => [
  {
    path: '/',
    name: prop + '.librerias',
    meta: { dark: mode, auth: true, name: 'librerias' },
    component: Librerias
  }
]

const AppsRoutes = (prop, mode) => [
  {
    path: 'apps',
    name: prop + '.apps',
    meta: { dark: mode, auth: true, name: 'apps' },
    component: Apps
  }
]
...
const AutosRoutes = (prop, mode) => [
  {
    path: 'autos',
    name: prop + '.autos',
    meta: { dark: mode, auth: true, name: 'Autos' },
    component: Autos
  }
]
...
const routes = [
  ...
  },
  {
    ...
    component: Layout1,
    meta: { auth: true },
    children: PracticasRoutes('practicas')
  },
  {
    path: '/',
    name: 'librerias',
    component: Layout1,
    meta: { auth: true },
    children: LibreriasRoutes('librerias')
  },
  {
    path: '/apps',
    name: 'apps',
  ...
  },
  {
    ...
    component: Layout1,
    meta: { auth: true },
    children: AlumnosRoutes('alumnos')
  },
  {
    path: '/autos',
    name: 'autos',
